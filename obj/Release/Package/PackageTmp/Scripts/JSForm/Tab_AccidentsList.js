...
function Tab_AccidentsList(Tab) {
   ...
   HTML="<div id='AccidentsPanel'>"+oCONTROLS.txt_imgINtxt(pWraper, ptxt, pui_img)+oCONTROLS.btnTextImg(pbtn)+"<div style='clear:both;'><h2 style='padding-top:20px;'>Paskutiniai įvykiai:</h2></div></div><div id='divGridAccidents'></div>";
   ...
   //   $("#proc_AccidentsGrid").resize(function(e) {
   //      //var h=$('#divGridAccidents').height()+$('#AccidentsPanel').height()+70;
   //      //$("#tabAccidents-center").height(h);
   //      //$("#tabAccidents-east").height(h);
   //      //$("#tabAccidents").height(h+20);
   //      oGLOBAL.Start.Tab.CheckTabHeight({ CtrlName: "#tabAccidents", LayOutPanel: "#tabAccidents-center", FirstResize: false });
   //   });
   //
   //-------------Grid rendering---End----------------------------------------------------------------------------------------------------
